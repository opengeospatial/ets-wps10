...
`org.opengis.cite.wps10`. A conformance class corresponds to a &lt;test&gt; element, each
...
|Conformance Level 1
|org.opengis.cite.wps10.level1.*

|Conformance Level 2
|org.opengis.cite.wps10.level2.*
