...
public class Namespaces {
	...
	/** Constant <code>TargetStandard="http://www.opengis.net/wps/1.0.0"</code> */
	public static final String TargetStandard = "http://www.opengis.net/wps/1.0.0";

	/** Constant <code>TargetStandardPrefix="wps"</code> */
	public static final String TargetStandardPrefix = "wps";
	...
	/** Constant <code>WPS="http://www.opengis.net/wps/1.0.0"</code> */
	public static final String WPS = "http://www.opengis.net/wps/1.0.0";
